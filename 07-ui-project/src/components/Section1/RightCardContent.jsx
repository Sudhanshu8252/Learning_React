...
const RightCardContent = (props) => {
  return (
    <div>
       ...
       <div >
        <p className=' text-shadow-2xs text-xl leading-relaxed text-white mb-14'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dignissimos delectus nihil, laboriosam eligendi vero quos.</p>
